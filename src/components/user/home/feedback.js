        ...
        <section class="py-16 mt-16 bg-center bg-cover bg-no-repeat group" style="background-image: url(https://res.cloudinary.com/levantuan/image/upload/v1642602275/fpoly/asm-js/pizi_coffe_1_r8_clients_say_row_bg_img_vc7e3r.jpg)">
            <div class="container max-w-6xl mx-auto">
                ...
                <ul id="home__feedback">
                    ...
                    <li class="text-center mt-9">
                        <img src="https://res.cloudinary.com/levantuan/image/upload/v1644636235/assignment-js/img_1062_89af8c0f-3d9b-49c5-4b09-33fc8d0a2f0d-300x300_rb8mcq.jpg" alt="" class="w-24 h-24 object-cover rounded-full mx-auto">
                        <ul class="flex text-yellow-500 justify-center mt-2">
                            <li>
                                <i class="fas fa-star"></i>
                            </li>
                    ...
                    <li class="text-center mt-9">
                        <img src="https://res.cloudinary.com/levantuan/image/upload/v1644636291/assignment-js/4302df8958f010703fef2d8187d869a6-280x280_yvpuzs.jpg" alt="" class="w-24 h-24 object-cover rounded-full mx-auto">
                        <ul class="flex text-yellow-500 justify-center mt-2">
                            <li>
                                <i class="fas fa-star"></i>
                            </li>
