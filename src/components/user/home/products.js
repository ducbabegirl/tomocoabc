    ...
    async render() {
        ...
        <section class="container max-w-6xl mx-auto py-9 px-3">
            <div class="text-center">
                ...
                <p>Chào mừng bạn đến với thiên đường vị giác của tomocoabc. Menu tomocoabc rất đa dạng món uống, đủ để đáp ứng khẩu vị “ưa chua chuộng béo” của bạn. Order và thưởng thức ngay nhé.</p>
            </div>
