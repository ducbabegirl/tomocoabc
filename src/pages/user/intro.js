        ...
        <section class="container max-w-6xl mx-auto px-3 py-9">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-2">
                <div class="text-justify leading-relaxed">
                    <p class="mb-3">
                        Thương hiệu trà và cà phê Cocomoco được thành lập vào năm 2019
                        với cửa hàng đầu tiên tại Royal City. Với triết lý kinh doanh
                        không ngừng phát triển và đưa thương hiệu Cocomoco ngày càng lớn
                        mạnh bằng hương vị trà và cà phê hảo hạng, quy trình phục vụ
                        chuyên nghiệp mà còn là không gian đẳng cấp sang trọng. Trong
                        suốt thời gian qua, Cocomoco luôn khẳng định vị thế của mình trên
                        thị trường và không ngừng mở rộng thương hiệu với 5 cửa hàng
                        mang thương hiệu Cocomoco tại các thành phố lớn: Hà Nội, Hồ Chí Minh,
                        Thái Bình và Bình Dương.
                    </p>
                    <p class="mb-3">
                    Cocomoco mang đến cho khách hàng sự trải nghiệm tuyệt vời chất lượng
                    ...
                    Cocomoco luôn làm khách hàng xao xuyến bởi vị chan chát đầu lưỡi,
                ...
                <p>
                    ...
                    sản phẩm cho tới dịch vụ. Trong suốt 4 năm hoạt động và phát triển,
                    Cocomoco đã đem tới cho hơn 1.000.000 thực khách những giây phút trải
                    nghiệm thực sự trong không gian sang trọng và đồ uống hảo hạng
                </p>
            </div>

            <div class="my-auto text-center">
                <img src="https://res.cloudinary.com/dizzurnqo/image/upload/v1702304177/ing_j3t8wu.png" alt="">
            </div>
        </div>
    </section>
