...
const ContactPage = {
    getTitle() {
        return "Liên hệ - Trà Sữa Tomocoabc";
    },
    async render() {
        ...
        <main>
            <section class="container max-w-6xl mx-auto px-3 py-8 text-center">
                <h1 class="text-2xl font-semibold text-[#D9A953] mb-2">Liên hệ với Tomocoabc</h1>
                <p>Từng ngày Tomocoabc trở nên hoàn thiện hơn về diện mạo, chất lượng sản phẩm dịch vụ là nhờ sự đóng góp ý kiến của quý khách hàng. Để cảm nhận được sự thay đổi ấy, đừng ngần ngại nói với Tomocoabc nhé.</p>
            </section>
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12">
                            <div class="flex items-center">
                                ...
                                <label for="contact__form-checkbox" class="ml-2">Tôi xác nhận các thông tin cá nhân cung cấp ở trên là hoàn toàn chính xác và đồng ý để Tomocoabc sử dụng các thông tin đó cho mục đích giải quyết phản hồi.</label>
                            </div>
            ...
            <section class="container max-w-6xl mx-auto px-3 py-10 leading-relaxed">
                ...
                <p>
                    Tomocoabc cam kết giữ bí mật hoàn toàn thông tin của Quý khách hàng theo đúng quy định 
                    pháp luật nước sở tại về quyền bảo mật thông tin có liên quan. Trường hợp xảy ra 
                    khiếu nại, than phiền, Tomocoabc có thể sẽ sử dụng thông tin khách hàng để chuyển giao 
                    đến bộ phận liên quan giải quyết:
                </p>
                <ul class="mb-5">
                    <li>1. Nội bộ các bộ phận trực thuộc Tomocoabc</li>
                    <li>
                        2. Bên thứ ba được ủy quyền chính thức từ Tomocoabc cho việc giải quyết các than phiền, 
                ...
                <ul class="mb-5">
                    <li>1. Tomocoabc cam kết bảo mật các thông tin mà khách hàng cung cấp và tuân thủ quy định 
                    ...
                    <li>
                        3. Tomocoabc có thể tiết lộ thông tin của khách hàng cho mục đích giải quyết khiếu nại, 
                        than phiền của khách hàng cho:
                        <ul>
                            <li>- Các bộ phận trực thuộc Cty cổ phần TMDV Chào ngày mới - Trà sữa Tomocoabc</li>
                            <li>
                                - Bên thứ ba được ủy quyền chính thức từ Trà sữa Tomocoabc cho việc giải quyết 
                ...
                <p>
                    ...
                    để Tomocoabc có thể liên hệ giải quyết vấn đề hoặc tiếp nhận ý kiến của khách 
