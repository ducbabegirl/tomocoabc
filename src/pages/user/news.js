...
const NewsPage = {
    getTitle() {
        return "Tin tức - Trà Sữa tomocoabc";
    },
    async render(pageNumber) {
        ...
        for (let i = 1; i <= totalPage; i++) {
            htmlPagination += `
            <li class="">
                <a href="/#/news/page/${i}"class="w-10 h-10 rounded-full border-2 flex items-center justify-center font-semibold mx-0.5 cursor-pointer transition ease-linear duration-200 hover:bg-[#D9A953] hover:border-[#D9A953] hover:text-white ${+currentPage === i ? "border-[#D9A953] bg-[#D9A953] text-white" : "border-gray-500 text-gray-500"}">${i}</a>
            </li>
            `;
        }
        ...
        <main>
            ...
            <section class="py-16 bg-[#EFE8DE] mt-6 min-h-[500px]">
                ...
                <ul class="flex justify-center mt-10">
                    ${currentPage > 1 ? `
                    <li>
                        <a href="/#/news/page/${currentPage - 1}" class="w-10 h-10 rounded-full border-2 flex items-center justify-center font-semibold border-gray-500 text-gray-500 mx-0.5 cursor-pointer transition ease-linear duration-200 hover:bg-[#D9A953] hover:border-[#D9A953] hover:text-white">
                            <button>
