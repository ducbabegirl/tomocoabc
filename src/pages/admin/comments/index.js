...
import AdminCmtList from "../../../components/admin/commentList";

const AdminCmtListPage = {
    getTitle() {
        return "Comment List | Administrator";
    },
    async render() {
        return /* html */ `
...
export default AdminCmtListPage;