                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-3">
                                        ...
                                        <div class="mt-1">
                                            <img src="https://res.cloudinary.com/dizzurnqo/image/upload/v1698072562/uploadimg_yzkpbo.jpg" alt="Preview Image" id="form__add-product-preview" class="h-60 w-full object-cover rounded-md">
                                        </div>
                                    </div>
